...
const BACKEND_PATH = "http://localhost:3000/api/me/commissioning-token";

describe("GET /api/me/commissioning-token", () => {
  it("SHOULD proxy the request to the backend commissioning-token endpoint", async () => {
    await GET(requestOf("/api/me/commissioning-token"));
...
describe("POST /api/me/commissioning-token", () => {
  it("SHOULD proxy the request to the backend commissioning-token endpoint", async () => {
    await POST(requestOf("/api/me/commissioning-token", { method: "POST", body: "{}" }));
...
describe("DELETE /api/me/commissioning-token", () => {
  it("SHOULD proxy the request to the backend commissioning-token endpoint", async () => {
    await DELETE(requestOf("/api/me/commissioning-token", { method: "DELETE" }));
